...
<html>
<head>
	<title><?php echo $title_fname; ?> • Nostalgia</title>
		...
		include ( "./inc/header.inc.php");
	    	...
	    	echo '<li style="float: right;">
					...
					<div >
						<nav>
						<ul>
						<li><a href="daowat.php?u='.$username.'" style="background-color: #cdcdcd; color: #0b810b">Post New</a></li>
					...
					<?php 
						if ($user == $username) {
							echo "
								...
								<input type='submit' name='uploadpic' value='Post' class='p_postSubmit' >
								</div>
								</form>
								</div>
							";
