			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						// send email
						$msg = "
						Get Your Nostalgic Moments from here!!
							...
							<div class="maincontent">
							   <?php
								if (isset($success_message)) {
									...
									echo '
									   <h2><font face="bookman">Recover Your Old Memories from here!</font></h2>
										<div class="maincontent_text">
										<font face="bookman"><br>
											<li>Not Only Illayaraja Songs give you a Nostalgic Moments we too!!</li>
